...
{
    let titleOfApp = ce("a");
    titleOfApp.textContent = ' CATopalian JavaScript Text Investigator';
    titleOfApp.href = 'https://github.com/ChristopherAndrewTopalian/CATopalian_JavaScript_Text_Investigator'
